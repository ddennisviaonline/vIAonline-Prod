...
$LinkToCsv = $LinksCache | ConvertTo-Csv -NoTypeInformation
...
$contentBase64 = [Convert]::ToBase64String([Text.Encoding]::UTF8.GetBytes($LinkToCsv  -join "`n"))
