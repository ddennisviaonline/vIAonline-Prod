...
try {
    ...
    $oficial = "$($dolaroficial.compra) | Venta: $($dolaroficial.venta)"
    
    $dolarBlue = $response | Where-Object { $_.casa -eq "blue" }
    $blue = "$($dolarBlue.compra) | Venta: $($dolarBlue.venta)"

    $dolarTarjeta = $response | Where-Object { $_.casa -eq "Tarjeta" }
    $Tarjeta = "$($dolarBlue.compra) | Venta: $($dolarTarjeta.venta)"
...
<body>
    ...
    <div class='encabezado-info'>
        ...
        <div class='clima'><span class='resaltado'>💵 Dólar oficial </span>$blue</div>
        <div class='clima'><span class='resaltado'>💵 Dólar oficial </span>$tarjeta</div<
