...
Write-Host "=== Eventos ==="
$ArrayEventos = $ArrayEventos | Sort-Object year -Descending | Select-Object -Last 8 

Write-Host "`n=== Nacimientos ==="
$ArrayNacimientos = $ArrayNacimientos | Sort-Object year -Descending | Select-Object -First 1

Write-Host "`n=== Fallecimientos ==="
$ArrayFallecimientos = $ArrayFallecimientos | Sort-Object year -Descending | Select-Object -First 1
