...
Write-Host "=== Eventos ==="
$ArrayEventos = $ArrayEventos | Sort-Object year | Select-Object -Last 5 

Write-Host "`n=== Nacimientos ==="
$ArrayNacimientos = $ArrayNacimientos | Sort-Object year | Select-Object -First 2

Write-Host "`n=== Fallecimientos ==="
$ArrayFallecimientos = $ArrayFallecimientos | Sort-Object year | Select-Object -First 2
